...
void usage(){
    fprintf(stderr, "-------------------------------------------------------------------------\n");
    fprintf(stderr, "basecounts: A tool to extract nucleotide counts\n");
    fprintf(stderr, "            of genomic loci from the BAM file. Version: %s\n", VERSION);
    fprintf(stderr, "USAGE:\n");
    fprintf(stderr, "    basecounts [OPTIONS] <loci> <bam>\n");
    fprintf(stderr, "    e.g; basecounts target_loci.tsv Tumor.bam\n");
    ...
    fprintf(stderr, "ARGS:\n");
    fprintf(stderr, "    <loci>   loci file (chr\\tpos)\n");
